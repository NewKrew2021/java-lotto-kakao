...
public class LottoTicketsTest {
    ...
    public void create(){
        Lotto ticket1 = Lotto.from(new LottoManualGenerator(Arrays.asList(1,2,3,4,5,6)));
        Lotto ticket2 = Lotto.from(new LottoManualGenerator(Arrays.asList(1,2,3,4,5,7)));
