...
public class Input {
    ...
    public static WinnerBalls getWinnerBallsFromUser() {
        ...
        List<Integer> userInputNumbers = getNumbersFromInputString(userInput);
    ...
    private static List<Integer> getNumbersFromInputString(String userInput) { //TODO: 유틸로 빼자.

        List<Integer> userInputNumbers = new ArrayList<>();

        for (String currentFragment : userInput.split(",")) {
